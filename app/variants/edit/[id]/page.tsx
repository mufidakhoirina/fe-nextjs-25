...
export default function EditVariantPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (variantRes.data.status && variantRes.data.data) {
          const variant = variantRes.data.data;
          setFormData({
            product_id: variant.product_id.toString(),
            product_category_id: variant.product_category_id.toString(),
        ...
        if (productsRes.data.status && Array.isArray(productsRes.data.data)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await api.put(`/variants/${id}`, formData);
